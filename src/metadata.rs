use crate::{
    consts::{BITRATES, SAMPLING_FREQ},
    enums::{ChannelType, Copyright, Emphasis, Error, Genre, Layer, Status, Version, CRC},
    types::{AudioTag, Frame, MP3Metadata, OptionalAudioTags},
    utils::{
        compute_duration, create_utf8_str, get_line, get_samp_line, get_text_field,
        get_text_fields, get_url_field, get_url_fields,
    },
};
